...
/**
 * Entry point of the 'Boilerplate' generation module.
 *
 * @generated
 */
public class Boilerplate extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/webshopGenerator/boilerplate";
     ...
     * @generated
     */
    public Boilerplate(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Boilerplate(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Boilerplate generator = new Boilerplate(modelURI, folder, arguments);
